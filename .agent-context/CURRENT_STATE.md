...
The seed robot/company data still needs deeper source verification and richer per-entity fields before full launch. Tesla Optimus/Tesla, Figure 01/Figure AI, Figure 02/Figure AI, Unitree G1/Unitree Robotics, Unitree H1/Unitree Robotics, Digit/Agility Robotics, Apollo/Apptronik, 1X NEO/1X Technologies, Sanctuary AI Phoenix/Sanctuary AI, Boston Dynamics Electric Atlas/Boston Dynamics, Fourier GR-1/Fourier Intelligence, UBTECH Walker S/UBTECH Robotics, and EngineAI PM01/EngineAI now have enriched/source-backed passes with sources, timeline entries, cautious status/availability wording, and visible program notes. Figure 01 is tracked as a discontinued/superseded predecessor with reported public specs; Figure 02 and Figure AI still preserve the imported HTML visual pages, with appended source-backed status panels to keep the gold-standard visual treatment while resolving current-status drift.
